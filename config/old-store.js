...
const useStore = create(
    persist(
        (set, get) => ({
            ...
            addToEnrolledCourses: (courseId) =>
                set((state) => ({ enrolledCourses: [...state.enrolledCourses, courseId] })),
            addToActiveCourse: (courseId) =>
                set((state) => ({ activeCourse: [...state.activeCourse, courseId] })),
            addToWishlist: (courseId) =>
                set((state) => ({ wishlist: [...state.wishlist, courseId] })),
            addToOwnCourses: (courseId) =>
                set((state) => ({ ownCourses: [...state.ownCourses, courseId] })),
