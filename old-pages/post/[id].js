            ...
            <Wrapper>
                ...
                <StyledCard variant="elevation" elevation={20}>
                    <iframe
                        width="100%"
                        height="100%"
                        src="https://www.youtube.com/embed/viKC9knLQUw"
                        allow="accelerometer; 
            ...
            <Box>
                <LessonCard variant="elevation" elevation={20}>
                    <Tabs>
                        ...
                        {!isCoursePurchased ? (
                            <TabPanel>
                                <Title style={{ textAlign: "left", margin: 5 }}>
                                    About the course
                                </Title>
                        ...
                        {/* // course outline */}
                        <TabPanel>
                            <Title style={{ textAlign: "left", marginLeft: 5 }}>
                                Course outline
                            </Title>
                                    ...
                                    {lessons.map((lesson, index) => (
                                        <LessonContainer key={index}>
                                            <Card variant="elevation" elevation={10}>
                                                <Title style={{ fontSize: 25, fontWeight: 600 }}>
                                                    {lesson.title}
                                                </Title>
                                                {lesson.pdfs?.map((pdf, index) => (
                                                    <VideoContainer key={index}>
                                                        <PdfLink href={pdf.link} target="_blank">
                                                            <CloudDownloadIcon
                                                                sx={{ mr: 1, mb: -0.7 }}
                                                            />
                                                            {pdf.title}
                ...
                <CheckoutBox>
                    <LessonInnerCard variant="elevation" elevation={20}>
                        ...
                        <Button onClick={handleEnroll} style={{ width: "100%" }}>
                            {!isCoursePurchased ? "Enroll" : null}
                        </Button>
                    </LessonInnerCard>
                </CheckoutBox>
            </Box>
