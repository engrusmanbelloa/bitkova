            ...
            <Box>
                    ...
                    <Tabs>
                        ...
                        <TabPanel>
                            ...
                            <Paragraph>
                                ...
                                amet habitasse orci convallis sodales augue. dolor in finibus
                        ...
                        <TabPanel>
                            ...
                            <Learn style={{ display: "flex", flexWrap: "wrap" }}>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet,</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur a</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet,</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur</LearnItem>
                                <LearnItem>Lorem ipsum dolor sit amet, consectetur a</LearnItem>
                        ...
                        <TabPanel>
                            ...
                            <ReviewBox>
                                ...
                                <Paragraph>
                                    ...
                                    fringilla morbi mauris gravida. Eu vel arcu neque vitae vitae
                                    justo. Sit integer faucibus in dictumst amet hac. Enim amet,
                                    elementum faucibus id ultrices facilisis. Integer sed aenean
                                    consectetur.”
                                </Paragraph>
                ...
                <CheckoutBox>
                    <Card
                        variant="elevation"
                        elevation={20}
                        sx={{ borderRadius: 3, textAlign: "center", width: "100%" }}
                    >
                        <Button style={{ width: "100%", marginBottom: 40 }}>Buy This Course</Button>
                        <Duration>
                            <AccessTimeFilledIcon
                                style={{ margin: "10px", fontSize: 50, color: "#1C3879" }}
                            />
